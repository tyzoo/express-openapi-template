...
const models: TsoaRoute.Models = {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "PaginateResult_Guestbook_": {
        "dataType": "refObject",
        "properties": {
            "docs": {"dataType":"array","array":{"dataType":"refObject","ref":"Guestbook"},"required":true},
            ...
            "prevPage": {"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]},{"dataType":"undefined"}]},
            "nextPage": {"dataType":"union","subSchemas":[{"dataType":"double"},{"dataType":"enum","enums":[null]},{"dataType":"undefined"}]},
            "pagingCounter": {"dataType":"double","required":true},
            "meta": {"dataType":"any"},
        },
        "additionalProperties": {"dataType":"union","subSchemas":[{"dataType":"array","array":{"dataType":"refObject","ref":"Guestbook"}},{"dataType":"double"},{"dataType":"boolean"},{"dataType":"enum","enums":[null]},{"dataType":"undefined"}]},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "FilterQueryParams": {
        "dataType": "refObject",
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "PaginateResult_Item_": {
        "dataType": "refObject",
        "properties": {
            "docs": {"dataType":"array","array":{"dataType":"refObject","ref":"Item"},"required":true},
            "totalDocs": {"dataType":"double","required":true},
            "limit": {"dataType":"double","required":true},
            "hasPrevPage": {"dataType":"boolean","required":true},
            "hasNextPage": {"dataType":"boolean","required":true},
        ...
        "additionalProperties": {"dataType":"union","subSchemas":[{"dataType":"array","array":{"dataType":"refObject","ref":"Item"}},{"dataType":"double"},{"dataType":"boolean"},{"dataType":"enum","enums":[null]},{"dataType":"undefined"}]},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "PaginateResult_APIKey_": {
        "dataType": "refObject",
        "properties": {
            "docs": {"dataType":"array","array":{"dataType":"refObject","ref":"APIKey"},"required":true},
            "totalDocs": {"dataType":"double","required":true},
            "limit": {"dataType":"double","required":true},
            "hasPrevPage": {"dataType":"boolean","required":true},
            "hasNextPage": {"dataType":"boolean","required":true},
        ...
        "additionalProperties": {"dataType":"union","subSchemas":[{"dataType":"array","array":{"dataType":"refObject","ref":"APIKey"}},{"dataType":"double"},{"dataType":"boolean"},{"dataType":"enum","enums":[null]},{"dataType":"undefined"}]},
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "APIKeyDoc": {
        "dataType": "refObject",
    ...
    "UserDoc": {
        ...
        "properties": {
            ...
            "scopes": {"dataType":"array","array":{"dataType":"refEnum","ref":"User_Scopes"}},
            "jwt": {"dataType":"string"},
            "_id": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        app.get('/guestbook',
            ...
            ...(fetchMiddlewares<RequestHandler>(GuestbookController.prototype.findAllItems)),

            function GuestbookController_findAllItems(request: any, response: any, next: any) {
            const args = {
                    queryParams: {"in":"queries","name":"queryParams","required":true,"ref":"FilterQueryParams"},
            };
        ...
        app.post('/guestbook',
            ...
            function GuestbookController_createItem(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"message":{"dataType":"string","required":true},"address":{"dataType":"string","required":true}}},
        ...
        app.get('/crud/:itemId',
            ...
            const args = {
                    itemId: {"in":"path","name":"itemId","required":true,"ref":"mongoose.Types.ObjectId"},
            };
        ...
        app.get('/captcha/new',
            ...
            function CaptchaController_newCaptcha(request: any, response: any, next: any) {
            const args = {
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
            ...
            try {
              ...
              const promise = controller.newCaptcha.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.post('/captcha/verify',
            ...(fetchMiddlewares<RequestHandler>(CaptchaController)),
            ...(fetchMiddlewares<RequestHandler>(CaptchaController.prototype.getSiweMessage)),

            function CaptchaController_getSiweMessage(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.getSiweMessage.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/tests',
            ...
            function TestsController_checkIfOnline(request: any, response: any, next: any) {
            const args = {
            };
            ...
            try {
              ...
              const promise = controller.checkIfOnline.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        app.get('/tests/rate-limiter',
            ...
            try {
              ...
              const promise = controller.rateLimiter.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/api-keys/:itemId',
            authenticateMiddleware([{"siwe":["user"]}]),
            ...(fetchMiddlewares<RequestHandler>(ApiKeyController)),
            ...(fetchMiddlewares<RequestHandler>(ApiKeyController.prototype.deleteApiKey)),

            function ApiKeyController_deleteApiKey(request: any, response: any, next: any) {
            const args = {
            ...
            try {
              ...
              const promise = controller.deleteApiKey.apply(controller, validatedArgs as any);
              promiseHandler(controller, promise, response, undefined, next);
            } catch (err) {
                return next(err);
            }
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.post('/auth/siwe-payload',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.getSiweMessage)),

            function AuthController_getSiweMessage(request: any, response: any, next: any) {
            const args = {
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"nonce":{"dataType":"string","required":true},"address":{"dataType":"string","required":true}}},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
        ...
        app.post('/auth/login',
            ...
            const args = {
                    expiresIn: {"in":"query","name":"expiresIn","required":true,"dataType":"string"},
                    body: {"in":"body","name":"body","required":true,"dataType":"nestedObjectLiteral","nestedProperties":{"siwe":{"dataType":"nestedObjectLiteral","nestedProperties":{"payload":{"dataType":"string","required":true},"signature":{"dataType":"string","required":true},"address":{"dataType":"string","required":true}},"required":true}}},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
